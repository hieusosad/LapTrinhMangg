...
public class ChatClient extends UnicastRemoteObject implements InterfaceClient{
        ...
        label.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    out.flush();
                    out.close();
                    JOptionPane.showMessageDialog(new JFrame(),"File đã được lưu tại " + System.getProperty("user.home") + separator + filename,"File đã được lưu",JOptionPane.INFORMATION_MESSAGE);
    ...
    public void closeChat(String message) throws RemoteException {
        ...
        JOptionPane.showMessageDialog(new JFrame(),message,"Cảnh báo",JOptionPane.WARNING_MESSAGE); 
    }
